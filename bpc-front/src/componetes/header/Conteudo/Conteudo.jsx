            ...
            <div className="max-w-7xl mx-auto p-4 md:px-10 flex justify-between items-center">
                <div className="flex flex-1 basis-0 justify-start">
                    <div className="w-full max-w-max md:max-w-40">
                        <button className="bg-white border border-gray-200 p-1.5 md:px-3 rounded-lg md:rounded-md flex w-full items-center justify-between cursor-pointer transition-all shadow-sm" >
        ...
        <div className="w-full bg-white border-b border-gray-100">
            <div className="max-w-7xl mx-auto p-4 md:px-10 flex justify-between items-center">
                <div className="flex items-center flex-1 basis-0 justify-start">
                    <div className="w-full max-w-max md:max-w-40">
                        <button onClick={() => setMostrarTodos(!mostrarTodos)} className="active:scale-95 bg-white border border-gray-200 p-1.5 md:px-3 rounded-lg md:rounded-md flex w-full items-center justify-between cursor-pointer transition-all hover:border-gray-300 shadow-sm" >
                            <img className="h-5 w-5 shrink-0" src={localizacao} alt="localização" />
                    ...
                    {mostrarTodos && (
                        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50" onClick={() => setMostrarTodos(false)}>
                            <div className="animate-fadein bg-white rounded-2xl p-6 gap-4 flex flex-col min-w-70 max-w-[90vw] shadow-2xl" onClick={(e) => e.stopPropagation()}>
                                <h3 className="font-bold text-xl text-gray-800 border-b pb-2">Localidade do Polo <p className="font-extralight text-sm">Google Maps</p></h3>
